...
ReadPackage( "CompilerForCAP", "gap/CompileCAPOperation.gi" );

ReadPackage( "CompilerForCAP", "gap/InferDataTypes.gi" );
...
ReadPackage( "CompilerForCAP", "gap/HoistExpressions.gi" );
