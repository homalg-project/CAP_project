      ...
      local pre_func, result_func;
        ...
        pre_func := function ( tree, additional_arguments )
            ...
            if CapJitIsCallToGlobalFunction( tree, gvar -> true ) then
                ...
                elif ForAny( tree.args, a -> a.type = "EXPR_DECLARATIVE_FUNC" ) and not tree.funcref.gvar in [ "ListN", "ListX", "Iterated", "CapFixpoint", "LazyHList", "NTuple", "CreateCapCategoryMorphismWithAttributes" ] then
