    ...
    result_func := function ( tree, result, keys, additional_arguments )
      local used_by_bindings, func, pre_func, unused_names, binding_name, key;
        ...
        if tree.type = "EXPR_DECLARATIVE_FUNC" then
            ...
            tree.nams := Filtered( tree.nams, name -> SafeUniquePosition( tree.nams, name ) <= tree.narg or name in tree.bindings.names );
            ...
            for binding_name in tree.bindings.names do
                ...
                pre_func := function ( tree, additional_arguments )
                    ...
                    # WARNING for refactoring: the logic for Iterated/IteratedListOfActions/CapFixpoint applies CapJitDroppedUnusedBindings to subtrees
