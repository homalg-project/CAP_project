...
#!   to warn about about bad compilation results. For example, `number_of_objectified_objects_in_data_structure_of_object` should be the number of calls to `ObjectifyObjectForCAPWithAttributes`
