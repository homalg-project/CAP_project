...
Proposition:
The additive closure of a pre-additive category with a homomorphism structure in an additive category is equipped with a homomorphism structure.
...
Lemma 1:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the distinguished object is an object in the range category of the homomorphism structure:
We have
function ( cat )
...
We have to show
function ( cat_1 )
    return IsWellDefinedForObjects( RangeCategoryOfHomomorphismStructure( cat_1 ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ) );
end
...
Lemma 2:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the homomorphism structure on objects defines an object in the range category of the homomorphism structure:
...
function ( cat_1, A_1, B_1 )
    return IsWellDefinedForObjects( RangeCategoryOfHomomorphismStructure( cat_1 ), DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( B_1 )[s_3] );
                      end ) );
            end ) ) );
end
gap> AttestValidInputs( );
...
Lemma 3:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the homomorphism structure on morphisms defines a morphism in the range category of the homomorphism structure:
...
function ( cat_1, A_1, B_1, C_1, D_1, alpha_1, beta_1 )
    return IsWellDefinedForMorphismsWithGivenSourceAndRange( RangeCategoryOfHomomorphismStructure( cat_1 ), DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( j_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( B_1 )[j_2], ObjectList( C_1 )[s_3] );
                      end ) );
            end ) ), MorphismBetweenDirectSums( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( j_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( B_1 )[j_2], ObjectList( C_1 )[s_3] );
                      end ) );
            end ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( j_2 )
                return List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( i_3 )
                        return MorphismBetweenDirectSums( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( s_4 )
                                  return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( B_1 )[j_2], ObjectList( C_1 )[s_4] );
                              end ), List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( s_4 )
                                  return List( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( t_5 )
                                          return HomomorphismStructureOnMorphisms( UnderlyingCategory( cat_1 ), MorphismMatrix( alpha_1 )[i_3][j_2], MorphismMatrix( beta_1 )[s_4][t_5] );
                                      end );
                              end ), List( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( t_4 )
                                  return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_3], ObjectList( D_1 )[t_4] );
                              end ) );
                    end );
            end ), List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( i_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( t_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_2], ObjectList( D_1 )[t_3] );
                      end ) );
            end ) ), DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( D_1 )[s_3] );
                      end ) );
            end ) ) );
end
gap> AttestValidInputs( );
...
Lemma 4:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the homomorphism structure preserves identities:
For two objects A and B we have
function ( cat, A, B )
...
Lemma 5:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the homomorphism structure is compatible with composition:
...
Lemma 6:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the homomorphism structue is additive in the first component:
...
Lemma 7:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, the homomorphism structure is additive in the second component:
...
Lemma 8:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, interpreting a morphism as a morphism from the distinguished object defines a morphism in the range category of the homomorphism structure:
...
function ( cat_1, A_1, B_1, alpha_1 )
    return IsWellDefinedForMorphismsWithGivenSourceAndRange( RangeCategoryOfHomomorphismStructure( cat_1 ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), UniversalMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( B_1 )[s_3] );
                      end ) );
            end ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_2 )
                return UniversalMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( B_1 )[s_3] );
                      end ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                          return InterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( UnderlyingCategory( cat_1 ), MorphismMatrix( alpha_1 )[j_2][s_3] );
                      end ) );
            end ) ), DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_2 )
                return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                          return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( B_1 )[s_3] );
...
Lemma 9:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, reinterpreting a morphism from the distinguished morphism as a usual morphism defines a morphism:
...
We have to show
function ( cat_1, A_1, B_1, alpha_1 )
    if not IsList( List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_2 )
                   return List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                           return InterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( B_1 )[s_3], ComponentOfMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), ComponentOfMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), alpha_1, List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_4 )
                                         return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_5 )
                                                   return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_4], ObjectList( B_1 )[s_5] );
                                               end ) );
                                     end ), j_2 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_4 )
                                       return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_2], ObjectList( B_1 )[s_4] );
                                   end ), s_3 ) );
                       end );
               end ) ) then
        return false;
    elif not ForAll( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( i_2 )
                 return IsList( List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_3 )
                           return InterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_2], ObjectList( B_1 )[s_3], ComponentOfMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), ComponentOfMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), alpha_1, List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_4 )
                                         return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_5 )
                                                   return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_4], ObjectList( B_1 )[s_5] );
                                               end ) );
                                     end ), i_2 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_4 )
                                       return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_2], ObjectList( B_1 )[s_4] );
                                   end ), s_3 ) );
                       end ) );
             end ) then
        return false;
                 ...
                 return ForAll( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( j_3 )
                         return IsWellDefinedForMorphismsWithGivenSourceAndRange( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_2], InterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_2], ObjectList( B_1 )[j_3], ComponentOfMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), ComponentOfMorphismIntoDirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), alpha_1, List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( j_4 )
                                         return DirectSum( RangeCategoryOfHomomorphismStructure( cat_1 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_5 )
                                                   return HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[j_4], ObjectList( B_1 )[s_5] );
                                               end ) );
                                     end ), i_2 ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( s_4 )
...
Lemma 10:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, interpreting morphisms as morphisms from the distinguished object is an injective operation:
For two objects A and B and a morphism alpha : A → B we have
function ( cat, A, B, alpha )
...
function ( cat_1, A_1, B_1, alpha_1 )
    return ForAll( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( i_2 )
            return ForAll( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( j_3 )
                    return IsCongruentForMorphisms( UnderlyingCategory( cat_1 ), InterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[i_2], ObjectList( B_1 )[j_3], InterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( UnderlyingCategory( cat_1 ), MorphismMatrix( alpha_1 )[i_2][j_3] ) ), MorphismMatrix( alpha_1 )[i_2][j_3] );
                end );
        end );
end
...
Lemma 11:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, interpreting morphisms as morphisms from the distinguished object is a surjective operation:
...
Lemma 12:
In the additive closure of a pre-additive category with a homomorphism structure in an additive category, interpreting morphisms as morphisms from the distinguished object is a natural transformation:
...
function ( cat_1, A_1, B_1, C_1, D_1, alpha_1, xi_1, beta_1 )
    return ForAll( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( logic_new_func_s_2 )
            return ForAll( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( logic_new_func_s_3 )
                    return IsCongruentForMorphisms( RangeCategoryOfHomomorphismStructure( cat_1 ), InterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( UnderlyingCategory( cat_1 ), SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( k_4 )
                                  return PreCompose( UnderlyingCategory( cat_1 ), SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( k_5 )
                                              return PreCompose( UnderlyingCategory( cat_1 ), SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( k_6 )
                                                          return PreCompose( UnderlyingCategory( cat_1 ), SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( k_7 )
                                                                      if logic_new_func_s_2 = k_7 then
                                                                          return MorphismMatrix( alpha_1 )[k_7][k_6];
                                                                      else
                                                                          return ZeroMorphism( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], ObjectList( B_1 )[k_6] );
                                                                      fi;
                                                                      return;
                                                                  end ), ObjectList( B_1 )[k_6] ), MorphismMatrix( xi_1 )[k_6][k_5] );
                                                      end ), ObjectList( C_1 )[k_5] ), MorphismMatrix( beta_1 )[k_5][k_4] );
                                          end ), ObjectList( D_1 )[k_4] ), CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                                              if k_4 = logic_new_func_s_3 then
                                                  return IdentityMorphism( UnderlyingCategory( cat_1 ), ObjectList( D_1 )[k_4] );
                                              else
                                                  return ZeroMorphism( UnderlyingCategory( cat_1 ), ObjectList( D_1 )[k_4], ObjectList( D_1 )[logic_new_func_s_3] );
                                              fi;
                                              return;
                                          end )(  ) );
                              end ), ObjectList( D_1 )[logic_new_func_s_3] ) ), SumOfMorphisms( RangeCategoryOfHomomorphismStructure( cat_1 ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( logic_new_func_k_4 )
                                return SumOfMorphisms( RangeCategoryOfHomomorphismStructure( cat_1 ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( logic_new_func_k_5 )
                                          return PreCompose( RangeCategoryOfHomomorphismStructure( cat_1 ), InterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( UnderlyingCategory( cat_1 ), MorphismMatrix( xi_1 )[logic_new_func_k_4][logic_new_func_k_5] ), HomomorphismStructureOnMorphisms( UnderlyingCategory( cat_1 ), MorphismMatrix( alpha_1 )[logic_new_func_s_2][logic_new_func_k_4], MorphismMatrix( beta_1 )[logic_new_func_k_5][logic_new_func_s_3] ) );
                                      end ), HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], ObjectList( D_1 )[logic_new_func_s_3] ) );
                            end ), HomomorphismStructureOnObjects( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], ObjectList( D_1 )[logic_new_func_s_3] ) ) );
                end );
        end );
end
...
function ( cat_1, A_1, B_1, C_1, D_1, alpha_1, xi_1, beta_1 )
    return ForAll( [ 1 .. Length( ObjectList( A_1 ) ) ], function ( logic_new_func_s_2 )
            return ForAll( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( logic_new_func_s_3 )
                    return IsCongruentForMorphisms( RangeCategoryOfHomomorphismStructure( cat_1 ), InterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( UnderlyingCategory( cat_1 ), SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( D_1 ) ) ], function ( k_4 )
                                  if k_4 = logic_new_func_s_3 then
                                      return SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( k_5 )
                                                return PreCompose( UnderlyingCategory( cat_1 ), SumOfMorphisms( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( k_6 )
                                                            return PreCompose( UnderlyingCategory( cat_1 ), MorphismMatrix( alpha_1 )[logic_new_func_s_2][k_6], MorphismMatrix( xi_1 )[k_6][k_5] );
                                                        end ), ObjectList( C_1 )[k_5] ), MorphismMatrix( beta_1 )[k_5][k_4] );
                                            end ), ObjectList( D_1 )[k_4] );
                                  else
                                      return ZeroMorphism( UnderlyingCategory( cat_1 ), ObjectList( A_1 )[logic_new_func_s_2], ObjectList( D_1 )[logic_new_func_s_3] );
                                  fi;
                                  return;
                              end ), ObjectList( D_1 )[logic_new_func_s_3] ) ), SumOfMorphisms( RangeCategoryOfHomomorphismStructure( cat_1 ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), List( [ 1 .. Length( ObjectList( B_1 ) ) ], function ( logic_new_func_k_4 )
                                return SumOfMorphisms( RangeCategoryOfHomomorphismStructure( cat_1 ), DistinguishedObjectOfHomomorphismStructure( UnderlyingCategory( cat_1 ) ), List( [ 1 .. Length( ObjectList( C_1 ) ) ], function ( logic_new_func_k_5 )
