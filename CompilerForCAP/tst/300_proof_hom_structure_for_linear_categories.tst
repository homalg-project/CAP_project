...
Proposition:
Any linear category with finitely generated free external homs is equipped wit\
h a homomorphism structure.
...
Lemma 1:
In any linear category with finitely generated free external homs, the disting\
uished object is an object in the range category of the homomorphism structure\
:
We have
function ( cat )
...
Lemma 2:
In any linear category with finitely generated free external homs, the homomor\
phism structure on objects defines an object in the range category of the homo\
morphism structure:
...
Lemma 3:
In any linear category with finitely generated free external homs, the homomor\
phism structure on morphisms defines a morphism in the range category of the h\
omomorphism structure:
    ...
    if
     not IsHomalgMatrix( 
            HomalgMatrixListList( 
              List( BasisOfExternalHom( cat_1, B_1, C_1 ), function ( ell_2 )
                     return 
                      CoefficientsOfMorphism( cat_1, 
                        PreComposeList( cat_1, A_1, [ alpha_1, ell_2, beta_1 ]
                           , D_1 ) );
                 end ), Length( BasisOfExternalHom( cat_1, B_1, C_1 ) ), 
              Length( BasisOfExternalHom( cat_1, A_1, D_1 ) ), 
              CommutativeRingOfLinearCategory( cat_1 ) ) ) then
        return false;
    elif
        ...
        not
           ...
           NumberRows( 
              HomalgMatrixListList( 
                List( BasisOfExternalHom( cat_1, B_1, C_1 ), 
                  function ( ell_2 )
                       return 
                        CoefficientsOfMorphism( cat_1, 
                          PreComposeList( cat_1, A_1, 
                            [ alpha_1, ell_2, beta_1 ], D_1 ) );
                   end ), Length( BasisOfExternalHom( cat_1, B_1, C_1 ) ), 
                Length( BasisOfExternalHom( cat_1, A_1, D_1 ) ), 
                CommutativeRingOfLinearCategory( cat_1 ) ) ) 
           = Length( BasisOfExternalHom( cat_1, B_1, C_1 ) ) then
        return false;
    elif
        ...
        not
           ...
           NumberColumns( 
              HomalgMatrixListList( 
                ...
                Length( BasisOfExternalHom( cat_1, A_1, D_1 ) ), 
                CommutativeRingOfLinearCategory( cat_1 ) ) ) 
           = Length( BasisOfExternalHom( cat_1, A_1, D_1 ) ) then
        return false;
    else
        return true;
    fi;
...
Lemma 4:
In any linear category with finitely generated free external homs, the homomor\
phism structure preserves identities:
For two objects A and B we have
function ( cat, A, B )
...
Lemma 5:
In any linear category with finitely generated free external homs, the homomor\
phism structure is compatible with composition:
...
Lemma 6:
In any linear category with finitely generated free external homs, the homomor\
phism structue is additive in the first component:
...
Lemma 7:
In any linear category with finitely generated free external homs, the homomor\
phism structure is additive in the second component:
...
Lemma 8:
In any linear category with finitely generated free external homs, interpretin\
g a morphism as a morphism from the distinguished object defines a morphism in\
 the range category of the homomorphism structure:
...
function ( cat_1, A_1, B_1, alpha_1 )
    if
     not IsHomalgMatrix( 
            HomalgRowVector( CoefficientsOfMorphism( cat_1, alpha_1 ), 
              Length( BasisOfExternalHom( cat_1, A_1, B_1 ) ), 
              CommutativeRingOfLinearCategory( cat_1 ) ) ) then
        return false;
    elif
        ...
        not
           ...
           NumberRows( HomalgRowVector( CoefficientsOfMorphism( cat_1, alpha_1 ), 
                Length( BasisOfExternalHom( cat_1, A_1, B_1 ) ), 
                CommutativeRingOfLinearCategory( cat_1 ) ) ) = 1 then
        return false;
    elif
     
        not
           
           NumberColumns( HomalgRowVector( CoefficientsOfMorphism( cat_1, alpha_1 )
                 , Length( BasisOfExternalHom( cat_1, A_1, B_1 ) ), 
                CommutativeRingOfLinearCategory( cat_1 ) ) ) 
           = Length( BasisOfExternalHom( cat_1, A_1, B_1 ) ) then
        return false;
    else
        return true;
    fi;
...
Lemma 9:
In any linear category with finitely generated free external homs, reinterpret\
ing a morphism from the distinguished morphism as a usual morphism defines a m\
orphism:
...
We have to show
function ( cat_1, A_1, B_1, alpha_1 )
    return IsWellDefinedForMorphismsWithGivenSourceAndRange( cat_1, A_1, 
       LinearCombinationOfMorphisms( cat_1, A_1, 
         EntriesOfHomalgRowVector( UnderlyingMatrix( alpha_1 ) ), 
         BasisOfExternalHom( cat_1, A_1, B_1 ), B_1 ), B_1 );
end
gap> AttestValidInputs( );
We let CompilerForCAP assume that all inputs are valid.
gap> AssertLemma( );
...
Lemma 10:
In any linear category with finitely generated free external homs, interpretin\
g morphisms as morphisms from the distinguished object is an injective operati\
on:
For two objects A and B and a morphism alpha : A → B we have
function ( cat, A, B, alpha )
    return 
...
We have to show
function ( cat_1, A_1, B_1, alpha_1 )
    return IsCongruentForMorphisms( cat_1, 
       LinearCombinationOfMorphisms( cat_1, A_1, 
         CoefficientsOfMorphism( cat_1, alpha_1 ), 
         BasisOfExternalHom( cat_1, A_1, B_1 ), B_1 ), alpha_1 );
end
...
Lemma 11:
In any linear category with finitely generated free external homs, interpretin\
g morphisms as morphisms from the distinguished object is a surjective operati\
on:
...
Lemma 12:
In any linear category with finitely generated free external homs, interpretin\
g morphisms as morphisms from the distinguished object is a natural transforma\
tion:
...
function ( cat_1, A_1, B_1, C_1, D_1, alpha_1, xi_1, beta_1 )
    return IsCongruentForMorphisms( cat_1, 
       PreComposeList( cat_1, A_1, [ alpha_1, xi_1, beta_1 ], D_1 ), 
       PreComposeList( cat_1, A_1, 
         [ alpha_1, 
            LinearCombinationOfMorphisms( cat_1, B_1, 
               List( [ 1 .. Length( BasisOfExternalHom( cat_1, B_1, C_1 ) ) ]
                  , function ( logic_new_func_k_2 )
                      return 
                       CoefficientsOfMorphism( cat_1, xi_1 )
                          [logic_new_func_k_2];
                  end ), BasisOfExternalHom( cat_1, B_1, C_1 ), C_1 ), beta_1 
           ], D_1 ) );
end
gap> # CoefficientsOfMorphism * BasisOfExternalHom
