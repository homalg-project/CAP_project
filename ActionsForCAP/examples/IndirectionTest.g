...
category_with_attributes_record := rec(
  ...
  ZeroObject :=
    function( zero_object )
      ...
      return [ "a string for indirection" ];
  ...
  KernelObject := 
    function( diagram, underlying_kernel_object )
  ...
  ImageObject := 
    function( diagram, underlying_image_object )
  ...
  FiberProduct := 
    function( diagram, underlying_fiber_product )
  ...
  CokernelObject := 
    function( diagram, underlying_cokernel_object )
  ...
  CoimageObject := 
    function( diagram, underlying_coimage_object )
  ...
  Pushout := 
    function( diagram, underlying_pushout_object )
