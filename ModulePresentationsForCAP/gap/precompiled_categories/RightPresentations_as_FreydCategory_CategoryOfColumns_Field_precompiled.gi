...
# Implementations
#
BindGlobal( "ADD_FUNCTIONS_FOR_RightPresentations_as_FreydCategory_CategoryOfColumns_Field_precompiled", function ( cat )
...
BindGlobal( "RightPresentations_as_FreydCategory_CategoryOfColumns_Field_precompiled", function ( ring )
  local category_constructor, cat;
    ...
    ADD_FUNCTIONS_FOR_RightPresentations_as_FreydCategory_CategoryOfColumns_Field_precompiled( cat );
