...
# Implementations
#
BindGlobal( "ADD_FUNCTIONS_FOR_LeftPresentations_as_FreydCategory_CategoryOfRows_CommutativeRing_precompiled", function ( cat )
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    deduped_2_1 := List( objects_1, function ( x_2 )
            return NumberColumns( UnderlyingMatrix( x_2 ) );
        end );
    deduped_1_1 := deduped_2_1[k_1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, objects_1[k_1], P_1, UnderlyingMatrix, UnionOfColumns( deduped_3_1, deduped_1_1, [ HomalgZeroMatrix( deduped_1_1, Sum( deduped_2_1{[ 1 .. k_1 - 1 ]} ), deduped_3_1 ), HomalgIdentityMatrix( deduped_1_1, deduped_3_1 ), HomalgZeroMatrix( deduped_1_1, Sum( deduped_2_1{[ k_1 + 1 .. Length( objects_1 ) ]} ), deduped_3_1 ) ] ) );
end
########
...
BindGlobal( "LeftPresentations_as_FreydCategory_CategoryOfRows_CommutativeRing_precompiled", function ( ring )
  local category_constructor, cat;
    ...
    ADD_FUNCTIONS_FOR_LeftPresentations_as_FreydCategory_CategoryOfRows_CommutativeRing_precompiled( cat );
