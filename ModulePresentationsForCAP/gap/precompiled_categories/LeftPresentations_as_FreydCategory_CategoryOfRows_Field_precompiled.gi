...
# Implementations
#
BindGlobal( "ADD_FUNCTIONS_FOR_LeftPresentations_as_FreydCategory_CategoryOfRows_Field_precompiled", function ( cat )
...
BindGlobal( "LeftPresentations_as_FreydCategory_CategoryOfRows_Field_precompiled", function ( ring )
  local category_constructor, cat;
    ...
    ADD_FUNCTIONS_FOR_LeftPresentations_as_FreydCategory_CategoryOfRows_Field_precompiled( cat );
