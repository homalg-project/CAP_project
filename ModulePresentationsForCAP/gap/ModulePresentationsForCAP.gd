...
DeclareGlobalFunction( "ADD_RANDOM_MORPHISM_WITH_FIXED_RANGE_LEFT" );

DeclareGlobalFunction( "ADD_RANDOM_MORPHISM_WITH_FIXED_SOURCE_RIGHT" );

DeclareGlobalFunction( "ADD_RANDOM_MORPHISM_WITH_FIXED_RANGE_RIGHT" );

DeclareGlobalFunction( "ADD_RANDOM_MORPHISM_WITH_FIXED_SOURCE_AND_RANGE" );
