...
InstallGlobalFunction( ADD_FUNCTIONS_FOR_LEFT_PRESENTATION,
  ...
  function( category )
    ...
    TRY_TO_ENHANCE_HOMALG_RING_WITH_RANDOM_FUNCTIONS( category!.ring_for_representation_category );
...
InstallGlobalFunction( ADD_RANDOM_OBJECT,
  ...
  function( category, left_or_right )
    ...
    AddRandomObjectByInteger( category,
      ...
      function( C, n )
        ...
        mat := homalg_ring!.random_matrix_func( nr_rows, nr_cols );
...
##
InstallGlobalFunction( TRY_TO_ENHANCE_HOMALG_RING_WITH_RANDOM_FUNCTIONS,
  function( R )
