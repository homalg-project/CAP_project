...
##
AddDerivationToCAP( CanonicalIdentificationFromImageObjectToCoimage,
                    "dualizing the derivation of CanonicalIdentificationFromCoimageToImageObject by CanonicalIdentificationFromCoimageToImageObject as the inverse of CanonicalIdentificationFromImageObjectToCoimage",
                    [
  ...
  function ( cat_1, alpha_1 )
    return InverseForMorphisms( cat_1, CanonicalIdentificationFromCoimageToImageObject( cat_1, alpha_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
...
AddDerivationToCAP( CoastrictionToImage,
                    "dualizing the derivation of AstrictionToCoimage by AstrictionToCoimage as the image embedding",
                    [
                        [ CoimageProjection, 1 ],
                        [ PostCompose, 1 ],
  ...
  function ( cat_1, alpha_1 )
    return PostCompose( cat_1, CanonicalIdentificationFromImageObjectToCoimage( cat_1, alpha_1 ), CoimageProjection( cat_1, alpha_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
...
AddDerivationToCAP( CoastrictionToImageWithGivenImageObject,
                    "dualizing the derivation of AstrictionToCoimageWithGivenCoimageObject by AstrictionToCoimage as the image embedding",
                    [
                        [ CoimageProjection, 1 ],
                        [ PostCompose, 1 ],
                        [ CanonicalIdentificationFromImageObjectToCoimage, 1 ],
...
AddDerivationToCAP( ImageEmbedding,
                    "dualizing the derivation of CoimageProjection by CoimageProjection as the coastriction to image",
                    [
                        [ CanonicalIdentificationFromCoimageToImageObject, 1 ],
  ...
  function ( cat_1, alpha_1 )
    return PostCompose( cat_1, AstrictionToCoimage( cat_1, alpha_1 ), CanonicalIdentificationFromCoimageToImageObject( cat_1, alpha_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
...
AddDerivationToCAP( ImageObject,
                    "dualizing the derivation of CoimageObject by CoimageObject as the range of CanonicalIdentificationFromImageObjectToCoimage",
                    [
                        [ CanonicalIdentificationFromCoimageToImageObject, 1 ],
                    ],
                    
  function ( cat_1, arg2_1 )
    return Source( CanonicalIdentificationFromCoimageToImageObject( cat_1, arg2_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
...
##
AddDerivationToCAP( ImageObject,
                    "dualizing the derivation of CoimageObject by CoimageObject as the source of CanonicalIdentificationFromCoimageToImageObject",
                    [
                        [ CanonicalIdentificationFromImageObjectToCoimage, 1 ],
                    ],
                    
  function ( cat_1, arg2_1 )
    return Range( CanonicalIdentificationFromImageObjectToCoimage( cat_1, arg2_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
...
AddDerivationToCAP( IsCodominating,
  ...
  function ( cat_1, arg2_1, arg3_1 )
    return IsDominating( cat_1, KernelEmbedding( cat_1, arg2_1 ), KernelEmbedding( cat_1, arg3_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
...
AddDerivationToCAP( UniversalMorphismFromImage,
                    "dualizing the derivation of UniversalMorphismIntoCoimage by UniversalMorphismIntoCoimage using UniversalMorphismFromImage and CanonicalIdentificationFromImageObjectToCoimage",
                    [
                        [ UniversalMorphismIntoCoimage, 1 ],
                        [ CanonicalIdentificationFromCoimageToImageObject, 1 ],
                        [ InverseForMorphisms, 1 ],
  ...
  function ( cat_1, alpha_1, tau_1 )
    return PostCompose( cat_1, InverseForMorphisms( cat_1, UniversalMorphismIntoCoimage( cat_1, alpha_1, NTuple( 2, tau_1[1], tau_1[2] ) ) ), CanonicalIdentificationFromCoimageToImageObject( cat_1, alpha_1 ) );
end : CategoryFilter := IsCapCategory,
      Weight := 1,
      is_autogenerated_by_CompilerForCAP := true );
