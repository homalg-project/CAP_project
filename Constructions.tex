...
Basic operations for $\mathbf{Ab}$-categories coming from the existenial quantifiers
in the definition.
\begin{itemize}
...
Basic operations for additive categories coming from the existenial quantifiers
in the definition
...
Basic operations for preadditive categories coming from the existenial quantifiers
in the definition
...
Basic operations for abelian categories coming from the existenial quantifiers
in the definition
