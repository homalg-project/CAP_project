...
The string is just the name of the category we create. For legacy reasons,\\
``\texttt{category\_as\_first\_argument := true}'' has to be set and will not be required in the future.
We can now continue by telling the category how operations on the objects or morphisms are performed by adding
...
properties of an Abelian category. For legacy reasons, ``\texttt{category\_as\_first\_argument := true}'' has to be set and will not be required in the future.
