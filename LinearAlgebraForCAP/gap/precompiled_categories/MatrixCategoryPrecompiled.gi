...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, UnderlyingMatrix, KroneckerMat( TransposedMatrix( deduped_5_1 ), KroneckerMat( deduped_8_1, KroneckerMat( deduped_8_1, ConvertMatrixToRow( deduped_9_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_12_1 ], function ( i_2 )
                                      local deduped_1_2;
                                      deduped_1_2 := (i_2 - 1);
                                      return (REM_INT( deduped_1_2, deduped_12_1 ) + QUO_INT( deduped_1_2, deduped_12_1 ) + 1);
                            ...
                            end ) ), deduped_7_1 ), deduped_7_1, deduped_7_1, deduped_13_1 ) ), deduped_9_1 ) ) * (KroneckerMat( deduped_5_1, deduped_4_1 ) * KroneckerMat( deduped_4_1, deduped_5_1 ) * KroneckerMat( ConvertMatrixToColumn( deduped_5_1 ), deduped_5_1 )) * KroneckerMat( deduped_10_1, deduped_9_1 ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( TransposedMatrix( deduped_3_1 ), UnderlyingMatrix( alpha_1 ) ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                          local deduped_1_2;
                          deduped_1_2 := (i_2 - 1);
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := ConvertMatrixToRow( HomalgIdentityMatrix( Dimension( Source( alpha_1 ) ), deduped_8_1 ) ) * (KroneckerMat( TransposedMatrix( deduped_3_1 ), UnderlyingMatrix( alpha_1 ) ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                            local deduped_1_2;
                            deduped_1_2 := (i_2 - 1);
                            return (REM_INT( deduped_1_2, deduped_5_1 ) + QUO_INT( deduped_1_2, deduped_5_1 ) + 1);
...
function ( cat_1, a_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, UnderlyingMatrix, KroneckerMat( TransposedMatrix( deduped_2_1 ), deduped_3_1 ) * (KroneckerMat( deduped_2_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                            return (hoisted_1_1 + (i_2 - 1) + 1);
                        end ) ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_4_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ (0 + (1 - 1) + 1) ] ), 1 ), 1, 1, deduped_4_1 ), deduped_3_1 ) * KroneckerMat( ConvertMatrixToColumn( deduped_2_1 ), deduped_3_1 )) );
end
########
...
function ( cat_1, a_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, UnderlyingMatrix, KroneckerMat( deduped_2_1, deduped_3_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                          local deduped_1_2;
                          deduped_1_2 := (i_2 - 1);
                          return (REM_INT( deduped_1_2, deduped_4_1 ) + QUO_INT( deduped_1_2, deduped_4_1 ) + 1);
                      end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_5_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, ConvertMatrixToColumn( deduped_3_1 ) ) );
end
########
...
function ( cat_1, a_1, s_1 )
    ...
    deduped_3_1 := HomalgIdentityMatrix( 1, deduped_5_1 );
    deduped_2_1 := HomalgIdentityMatrix( deduped_4_1, deduped_5_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, a_1, UnderlyingMatrix, KroneckerMat( deduped_2_1, deduped_3_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                          local deduped_1_2;
                          deduped_1_2 := (i_2 - 1);
                          return (REM_INT( deduped_1_2, deduped_4_1 ) + QUO_INT( deduped_1_2, deduped_4_1 ) + 1);
                      end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_5_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, ConvertMatrixToColumn( deduped_3_1 ) ) );
...
function ( cat_1, a_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, UnderlyingMatrix, KroneckerMat( deduped_2_1, ConvertMatrixToRow( deduped_3_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                          return (hoisted_1_1 + (i_2 - 1) + 1);
                      end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_5_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, deduped_3_1 ) );
end
########
...
function ( cat_1, a_1, r_1 )
    ...
    deduped_2_1 := HomalgIdentityMatrix( deduped_4_1, deduped_5_1 );
    hoisted_1_1 := 0 * deduped_4_1;
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, r_1, UnderlyingMatrix, KroneckerMat( deduped_2_1, ConvertMatrixToRow( deduped_3_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                          return (hoisted_1_1 + (i_2 - 1) + 1);
                      end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_5_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, deduped_3_1 ) );
end
########
...
function ( cat_1, a_1 )
    ...
    deduped_3_1 := HomalgIdentityMatrix( deduped_5_1, deduped_4_1 );
    deduped_2_1 := HomalgIdentityMatrix( 1, deduped_4_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, UnderlyingMatrix, KroneckerMat( ConvertMatrixToRow( deduped_2_1 ), deduped_3_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ (0 + (1 - 1) + 1) ] ), 1 ), 1, 1, deduped_4_1 ), deduped_3_1 ) * KroneckerMat( deduped_2_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                          local deduped_1_2;
                          deduped_1_2 := (i_2 - 1);
                          return (REM_INT( deduped_1_2, deduped_5_1 ) + QUO_INT( deduped_1_2, deduped_5_1 ) + 1);
                      end ) ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_4_1 ) ) * KroneckerMat( TransposedMatrix( deduped_2_1 ), deduped_3_1 ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( ConvertMatrixToRow( deduped_4_1 ), deduped_7_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                    ...
                    end ) ), deduped_6_1 ), deduped_6_1, deduped_6_1, deduped_8_1 ) ) * KroneckerMat( TransposedMatrix( deduped_4_1 ), UnderlyingMatrix( alpha_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, Dimension, 1 ), CreateCapCategoryObjectWithAttributes( cat_1, Dimension, NumberColumns( morphism_attr_1_1 ) ), UnderlyingMatrix, morphism_attr_1_1 );
end
########
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, UnderlyingMatrix, KroneckerMat( deduped_9_1, deduped_10_1 ) * (KroneckerMat( ConvertMatrixToRow( deduped_7_1 ), deduped_7_1 ) * KroneckerMat( deduped_6_1, deduped_7_1 ) * KroneckerMat( deduped_7_1, deduped_6_1 ) * KroneckerMat( TransposedMatrix( deduped_7_1 ), (KroneckerMat( KroneckerMat( deduped_9_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_12_1 ], function ( i_2 )
                                  local deduped_1_2;
                                  deduped_1_2 := (i_2 - 1);
                                  return (REM_INT( deduped_1_2, deduped_14_1 ) * deduped_16_1 + QUO_INT( deduped_1_2, deduped_14_1 ) + 1);
                                    ...
                                    return (hoisted_5_1 + (i_2 - 1) + 1);
                                end ) ), deduped_16_1 ), deduped_16_1, deduped_16_1, deduped_15_1 ), deduped_10_1 ) * KroneckerMat( deduped_13_1, ConvertMatrixToColumn( deduped_10_1 ) )) )) )) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( ConvertMatrixToRow( deduped_4_1 ), deduped_7_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_5_1 ], function ( i_2 )
                          ...
                          return (hoisted_3_1 + (i_2 - 1) + 1);
                      end ) ), deduped_6_1 ), deduped_6_1, deduped_6_1, deduped_9_1 ) ) * KroneckerMat( TransposedMatrix( deduped_4_1 ), UnderlyingMatrix( alpha_1 ) ) * ConvertMatrixToColumn( deduped_4_1 );
