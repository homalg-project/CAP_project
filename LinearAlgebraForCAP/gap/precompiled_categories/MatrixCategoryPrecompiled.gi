...
function ( cat_1, a_1, b_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( TransposedMatrix( deduped_6_1 ), KroneckerMat( deduped_9_1, KroneckerMat( deduped_9_1, ConvertMatrixToRow( deduped_10_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_13_1 ] ), deduped_13_1 ), deduped_13_1, deduped_13_1, deduped_14_1 ), deduped_10_1 ) * KroneckerMat( deduped_10_1, deduped_10_1 ) ) * KroneckerMat( KroneckerMat( (KroneckerMat( deduped_9_1, ConvertMatrixToRow( deduped_11_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_12_1 ] ), deduped_12_1 ), deduped_12_1, deduped_12_1, deduped_14_1 ), deduped_11_1 ) * KroneckerMat( deduped_11_1, deduped_11_1 )), deduped_10_1 ), deduped_10_1 ) * KroneckerMat( KroneckerMat( deduped_11_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_8_1 ], function ( i_2 )
                              local deduped_1_2;
                              deduped_1_2 := (i_2 - 1);
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return AsCapCategoryMorphism( cat_1, s_1, KroneckerMat( TransposedMatrix( deduped_5_1 ), KroneckerMat( deduped_8_1, KroneckerMat( deduped_8_1, ConvertMatrixToRow( deduped_9_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_12_1 ] ), deduped_12_1 ), deduped_12_1, deduped_12_1, deduped_13_1 ), deduped_9_1 ) * KroneckerMat( deduped_9_1, deduped_9_1 ) ) * KroneckerMat( KroneckerMat( (KroneckerMat( deduped_8_1, ConvertMatrixToRow( deduped_10_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_11_1 ] ), deduped_11_1 ), deduped_11_1, deduped_11_1, deduped_13_1 ), deduped_10_1 ) * KroneckerMat( deduped_10_1, deduped_10_1 )), deduped_9_1 ), deduped_9_1 ) * KroneckerMat( KroneckerMat( deduped_10_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_7_1 ], function ( i_2 )
                                local deduped_1_2;
                                deduped_1_2 := (i_2 - 1);
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := KroneckerMat( TransposedMatrix( deduped_3_1 ), AsHomalgMatrix( alpha_1 ) ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_5_1 ] ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_7_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                          local deduped_1_2;
                          deduped_1_2 := (i_2 - 1);
...
function ( cat_1, a_1 )
    ...
    deduped_3_1 := HomalgIdentityMatrix( deduped_7_1, deduped_8_1 );
    morphism_attr_1_1 := ConvertMatrixToRow( deduped_3_1 ) * (KroneckerMat( TransposedMatrix( deduped_3_1 ), deduped_3_1 ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_7_1 ] ), deduped_7_1 ), deduped_7_1, deduped_7_1, deduped_8_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                            local deduped_1_2;
                            deduped_1_2 := (i_2 - 1);
                            return (REM_INT( deduped_1_2, deduped_7_1 ) * deduped_7_1 + QUO_INT( deduped_1_2, deduped_7_1 ) + 1);
...
function ( cat_1, alpha_1 )
    ...
    morphism_attr_1_1 := ConvertMatrixToRow( HomalgIdentityMatrix( AsInteger( Source( alpha_1 ) ), deduped_8_1 ) ) * (KroneckerMat( TransposedMatrix( deduped_3_1 ), AsHomalgMatrix( alpha_1 ) ) * (KroneckerMat( deduped_3_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_5_1 ] ), deduped_5_1 ), deduped_5_1, deduped_5_1, deduped_8_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                            local deduped_1_2;
                            deduped_1_2 := (i_2 - 1);
                            return (REM_INT( deduped_1_2, deduped_5_1 ) * deduped_5_1 + QUO_INT( deduped_1_2, deduped_5_1 ) + 1);
...
function ( cat_1, a_1 )
    ...
    return AsCapCategoryMorphism( cat_1, a_1, KroneckerMat( deduped_1_1, deduped_2_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_3_1 ] ), deduped_3_1 ), deduped_3_1, deduped_3_1, deduped_4_1 ), deduped_2_1 ) * KroneckerMat( deduped_1_1, ConvertMatrixToColumn( deduped_2_1 ) ), a_1 );
end
########
...
function ( cat_1, a_1, s_1 )
    ...
    deduped_2_1 := HomalgIdentityMatrix( 1, deduped_4_1 );
    deduped_1_1 := HomalgIdentityMatrix( deduped_3_1, deduped_4_1 );
    return AsCapCategoryMorphism( cat_1, s_1, KroneckerMat( deduped_1_1, deduped_2_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_3_1 ] ), deduped_3_1 ), deduped_3_1, deduped_3_1, deduped_4_1 ), deduped_2_1 ) * KroneckerMat( deduped_1_1, ConvertMatrixToColumn( deduped_2_1 ) ), a_1 );
end
########
...
function ( cat_1, a_1 )
    ...
    deduped_2_1 := HomalgIdentityMatrix( deduped_4_1, deduped_3_1 );
    deduped_1_1 := HomalgIdentityMatrix( 1, deduped_3_1 );
    return AsCapCategoryMorphism( cat_1, a_1, KroneckerMat( ConvertMatrixToRow( deduped_1_1 ), deduped_2_1 ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ (0 + (1 - 1) + 1) ] ), 1 ), 1, 1, deduped_3_1 ), deduped_2_1 ) * KroneckerMat( deduped_1_1, HomalgMatrix( PermutationMat( PermList( [ 1 .. deduped_4_1 ] ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_3_1 ) ) * KroneckerMat( TransposedMatrix( deduped_1_1 ), deduped_2_1 ), a_1 );
end
########
