...
function ( cat_1, a_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, UnderlyingMatrix, KroneckerMat( TransposedMatrix( deduped_1_1 ), deduped_2_1 ) * (KroneckerMat( deduped_1_1, HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_4_1 ], function ( i_2 )
                            return (0 + (i_2 - 1) + 1);
                        end ) ), deduped_4_1 ), deduped_4_1, deduped_4_1, deduped_3_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( [ (0 + (1 - 1) + 1) ] ), 1 ), 1, 1, deduped_3_1 ), deduped_2_1 ) * KroneckerMat( ConvertMatrixToColumn( deduped_1_1 ), deduped_2_1 )) );
end
########
...
function ( cat_1, a_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, UnderlyingMatrix, KroneckerMat( deduped_1_1, ConvertMatrixToRow( deduped_2_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_3_1 ], function ( i_2 )
                          return (0 + (i_2 - 1) + 1);
                      end ) ), deduped_3_1 ), deduped_3_1, deduped_3_1, deduped_4_1 ), deduped_2_1 ) * KroneckerMat( deduped_1_1, deduped_2_1 ) );
end
########
...
function ( cat_1, a_1, r_1 )
    ...
    deduped_2_1 := HomalgIdentityMatrix( 1, deduped_4_1 );
    deduped_1_1 := HomalgIdentityMatrix( deduped_3_1, deduped_4_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, r_1, UnderlyingMatrix, KroneckerMat( deduped_1_1, ConvertMatrixToRow( deduped_2_1 ) ) * KroneckerMat( HomalgMatrix( PermutationMat( PermList( List( [ 1 .. deduped_3_1 ], function ( i_2 )
                          return (0 + (i_2 - 1) + 1);
                      end ) ), deduped_3_1 ), deduped_3_1, deduped_3_1, deduped_4_1 ), deduped_2_1 ) * KroneckerMat( deduped_1_1, deduped_2_1 ) );
end
########
