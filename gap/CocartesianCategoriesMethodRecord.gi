...
CoproductOnMorphisms := rec(
  ...
  output_source_getter_string := "CoproductOp( cat, Source( alpha ), Source( beta ) )",
  output_range_getter_string := "CoproductOp( cat, Range( alpha ), Range( beta ) )",
...
CocartesianAssociatorRightToLeft := rec(
  ...
  io_type := [ [ "a", "b", "c" ], [ "s", "r" ] ],
  output_source_getter_string := "CoproductOp( cat, a, CoproductOp( cat, b, c ) )",
  output_range_getter_string := "CoproductOp( cat, CoproductOp( cat, a, b ), c )",
  with_given_object_position := "both",
  return_type := "morphism",
...
CocartesianAssociatorLeftToRight := rec(
  filter_list := [ "category", "object", "object", "object" ],
  io_type := [ [ "a", "b", "c" ], [ "s", "r" ] ],
  output_source_getter_string := "CoproductOp( cat, CoproductOp( cat, a, b ), c )",
  output_range_getter_string := "CoproductOp( cat, a, CoproductOp( cat, b, c ) )",
  with_given_object_position := "both",
  return_type := "morphism",
...
CocartesianLeftUnitor := rec(
  ...
  io_type := [ [ "a" ], [ "s", "a" ] ],
  output_source_getter_string := "CoproductOp( cat, InitialObject( cat ), a )",
...
CocartesianLeftUnitorInverse := rec(
  ...
  output_range_getter_string := "CoproductOp( cat, InitialObject( cat ), a )",
...
CocartesianRightUnitor := rec(
  filter_list := [ "category", "object" ],
  io_type := [ [ "a" ], [ "s", "a" ] ],
  output_source_getter_string := "CoproductOp( cat, a, InitialObject( cat ) )",
  output_range_getter_string := "a",
  with_given_object_position := "Source",
  return_type := "morphism",
...
CocartesianRightUnitorInverse := rec(
  ...
  io_type := [ [ "a" ], [ "a", "r" ] ],
  output_source_getter_string := "a",
  output_range_getter_string := "CoproductOp( cat, a, InitialObject( cat ) )",
  with_given_object_position := "Range",
  return_type := "morphism",
