...
CocartesianBraiding := rec(
  ...
  io_type := [ [ "a", "b" ], [ "s", "r" ] ],
  output_source_getter_string := "CoproductOp( cat, a, b )",
  output_range_getter_string := "CoproductOp( cat, b, a )",
...
CocartesianBraidingInverse := rec(
  filter_list := [ "category", "object", "object" ],
  io_type := [ [ "a", "b" ], [ "s", "r" ] ],
  output_source_getter_string := "CoproductOp( cat, b, a )",
  output_range_getter_string := "CoproductOp( cat, a, b )",
  with_given_object_position := "both",
  return_type := "morphism",
