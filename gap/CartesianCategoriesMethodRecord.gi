...
DirectProductOnMorphisms := rec(
  ...
  output_source_getter_string := "DirectProduct( cat, Source( alpha ), Source( beta ) )",
  output_range_getter_string := "DirectProduct( cat, Range( alpha ), Range( beta ) )",
...
CartesianAssociatorRightToLeft := rec(
  ...
  io_type := [ [ "a", "b", "c" ], [ "s", "r" ] ],
  output_source_getter_string := "DirectProduct( cat, a, DirectProduct( cat, b, c ) )",
  output_range_getter_string := "DirectProduct( cat, DirectProduct( cat, a, b ), c )",
  with_given_object_position := "both",
  return_type := "morphism" ),
...
CartesianAssociatorLeftToRight := rec(
  filter_list := [ "category", "object", "object", "object" ],
  io_type := [ [ "a", "b", "c" ], [ "s", "r" ] ],
  output_source_getter_string := "DirectProduct( cat, DirectProduct( cat, a, b ), c )",
  output_range_getter_string := "DirectProduct( cat, a, DirectProduct( cat, b, c ) )",
  with_given_object_position := "both",
  return_type := "morphism" ),
...
CartesianLeftUnitor := rec(
  ...
  io_type := [ [ "a" ], [ "s", "a" ] ],
  output_source_getter_string := "DirectProduct( cat, TerminalObject( cat ), a )",
...
CartesianLeftUnitorInverse := rec(
  ...
  output_range_getter_string := "DirectProduct( cat, TerminalObject( cat ), a )",
...
CartesianRightUnitor := rec(
  filter_list := [ "category", "object" ],
  io_type := [ [ "a" ], [ "s", "a" ] ],
  output_source_getter_string := "DirectProduct( cat, a, TerminalObject( cat ) )",
  output_range_getter_string := "a",
  with_given_object_position := "Source",
  return_type := "morphism" ),
...
CartesianRightUnitorInverse := rec(
  ...
  io_type := [ [ "a" ], [ "a", "r" ] ],
  output_source_getter_string := "a",
  output_range_getter_string := "DirectProduct( cat, a, TerminalObject( cat ) )",
  with_given_object_position := "Range",
  return_type := "morphism" ),
