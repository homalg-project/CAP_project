...
InstallGlobalFunction( INSTALL_FUNCTIONS_FOR_CAP_CATEGORY_OF_PROJECTIVE_GRADED_LEFT_MODULES,
  ...
  function( category )
    ...
    AddKernelObject( category,
      function( morphism )
        local homalg_graded_ring, kernel_matrix, non_zero_entries_index, expanded_degree_list, j, k,
             degrees_of_kernel_matrix_rows, degrees_of_kernel_object, i;
        ...
        if IsZero( kernel_matrix ) then
          ...
          for i in [ 1 .. Length( degrees_of_kernel_matrix_rows ) ] do
            ...
            degrees_of_kernel_object[ i ] := [ expanded_degree_list[ non_zero_entries_index[ i ] ]
    ...
    AddKernelEmbedding( category,
      function( morphism )
        local homalg_graded_ring, kernel_matrix, non_zero_entries_index, expanded_degree_list, j, k,
             degrees_of_kernel_matrix_rows, degrees_of_kernel_object, i, kernel_object;
    ...
    AddCokernelObject( category,
      function( morphism )
        local homalg_graded_ring, cokernel_matrix, non_zero_entries_index, expanded_degree_list, j, k,
             degrees_of_cokernel_matrix_columns, degrees_of_cokernel_object, i;
        ...
        if IsZero( cokernel_matrix ) then
          ...
          for i in [ 1 .. Length( degrees_of_cokernel_matrix_columns ) ] do
            ...
            degrees_of_cokernel_object[ i ] := [ expanded_degree_list[ non_zero_entries_index[ i ] ]
  ...
  function( category )
    ...
    AddProjectionInFactorOfDirectSumWithGivenDirectSum( category,
      function( object_list, projection_number, direct_sum_object )
        ...
        projection_in_factor := UnionOfRows( projection_in_factor, 
                                             HomalgZeroMatrix( rank_post, rank_factor, homalg_graded_ring ) );
        projection_in_factor := HomalgMatrix(
                                 TransposedMat( EntriesOfHomalgMatrixAsListList( projection_in_factor ) ), homalg_graded_ring );
    ...
    AddUniversalMorphismIntoDirectSumWithGivenDirectSum( category,
      function( diagram, sink, direct_sum )
        ...
        od;
        underlying_matrix_of_universal_morphism :=         
                       HomalgMatrix( TransposedMat( EntriesOfHomalgMatrixAsListList( underlying_matrix_of_universal_morphism )),
                                                                                      UnderlyingHomalgGradedRing( sink[ 1 ] ) );
    ...
    AddInjectionOfCofactorOfDirectSumWithGivenDirectSum( category,
      function( object_list, injection_number, coproduct )
        ...
        injection_of_cofactor := UnionOfColumns( injection_of_cofactor,
                                             HomalgZeroMatrix( rank_cofactor, rank_post, homalg_graded_ring ) );
        injection_of_cofactor := HomalgMatrix( TransposedMat( EntriesOfHomalgMatrixAsListList( injection_of_cofactor ) ),
												           homalg_graded_ring );
    ...
    AddUniversalMorphismFromDirectSumWithGivenDirectSum( category,
      function( diagram, sink, coproduct )
        ...
        underlying_matrix_of_universal_morphism := 
                                      HomalgMatrix( EntriesOfHomalgMatrixAsListList ( underlying_matrix_of_universal_morphism ), 
                                                                                       UnderlyingHomalgGradedRing( sink[ 1 ]) );
    ...
    AddKernelEmbedding( category,
      function( morphism )
        local homalg_graded_ring, kernel_matrix, degrees_of_kernel_matrix_columns, i, degrees_of_kernel_object, counter, 
             counter2, kernel_object;
        ...
        counter := 1;
        counter2 := 1;
        for i in [ 1 .. Length( degrees_of_kernel_matrix_columns ) ] do
        
          degrees_of_kernel_object[ i ] := [ DegreeList( Source( morphism ) )[ counter ][ 1 ]
                                                                                   + degrees_of_kernel_matrix_columns[ i ], 1 ];
