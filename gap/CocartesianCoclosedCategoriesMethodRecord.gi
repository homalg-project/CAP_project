...
CocartesianEvaluationMorphism := rec(
  ...
  output_range_getter_string := "CoproductOp( cat, CoexponentialOnObjects( cat, a, b ), b )",
...
CocartesianCoevaluationMorphism := rec(
  filter_list := [ "category", "object", "object" ],
  io_type := [ [ "a", "b" ], [ "s", "a" ] ],
  output_source_getter_string := "CoexponentialOnObjects( cat, CoproductOp( cat, a, b ), b )",
...
CocartesianPreCoComposeMorphism := rec(
  ...
  output_range_getter_string := "CoproductOp( cat, CoexponentialOnObjects( cat, b, c ), CoexponentialOnObjects( cat, a, b ) )",
  with_given_object_position := "both",
  return_type := "morphism",
...
CocartesianPostCoComposeMorphism := rec(
  ...
  io_type := [ [ "a", "b", "c" ], [ "s", "r" ] ],
  output_source_getter_string := "CoexponentialOnObjects( cat, a, c )",
  output_range_getter_string := "CoproductOp( cat, CoexponentialOnObjects( cat, a, b ), CoexponentialOnObjects( cat, b, c ) )",
  with_given_object_position := "both",
  return_type := "morphism",
...
CocartesianEvaluationForCocartesianDual := rec(
  ...
  output_range_getter_string := "CoproductOp( cat, CocartesianDualOnObjects( cat, a ), a )",
  with_given_object_position := "both",
  return_type := "morphism",
...
CoexponentialCoproductCompatibilityMorphism := rec(
  ...
  output_source_getter_string := "CoexponentialOnObjects( cat, CoproductOp( cat, list[1], list[2] ), CoproductOp( cat, list[3], list[4] ) )",
  output_range_getter_string := "CoproductOp( cat, CoexponentialOnObjects( cat, list[1], list[3] ), CoexponentialOnObjects( cat, list[2], list[4] ) )",
  with_given_object_position := "both",
  return_type := "morphism",
...
CocartesianDualityCoproductCompatibilityMorphism := rec(
  filter_list := [ "category", "object", "object" ],
  io_type := [ [ "a", "b" ], [ "s", "r" ] ],
  output_source_getter_string := "CocartesianDualOnObjects( cat, CoproductOp( cat, a, b ) )",
  output_range_getter_string := "CoproductOp( cat, CocartesianDualOnObjects( cat, a ), CocartesianDualOnObjects( cat, b ) )",
  with_given_object_position := "both",
  return_type := "morphism",
...
MorphismFromCoexponentialToCoproduct := rec(
  ...
  output_range_getter_string := "CoproductOp( cat, CocartesianDualOnObjects( cat, b ), a )",
  with_given_object_position := "both",
  return_type := "morphism",
