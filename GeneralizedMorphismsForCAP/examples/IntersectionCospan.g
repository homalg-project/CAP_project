...
Serre_cat := SerreQuotientCategoryByCospans( LeftPresentations( R ), zero_support_tester );
...
dimension_of_factor := function( object )
  local underlying_object, number_of_generators, list_of_generators, growing_morphism, generator, serre_generator, dimension;
    ...
    for generator in list_of_generators do
        ...
        serre_generator := AsSerreQuotientCategoryByCospansMorphism( Serre_cat, generator );
...
im4_tilde := AsSerreQuotientCategoryByCospansObject( Serre_cat, im4 );

quot1 := AsSerreQuotientCategoryByCospansObject( Serre_cat, quot1 );
quot2 := AsSerreQuotientCategoryByCospansObject( Serre_cat, quot2 );
quot3 := AsSerreQuotientCategoryByCospansObject( Serre_cat, quot3 );
quot4 := AsSerreQuotientCategoryByCospansObject( Serre_cat, quot4 );
