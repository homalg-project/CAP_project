...
#! The output is the category of graded left presentations
#! over $R$.
#! @Returns a category
#! @Arguments R
...
#! @Description
#! The argument is a graded homalg ring $R$.
#! The output is the category of graded right presentations
#! over $R$.
#! @Returns a category
#! @Arguments R
...
DeclareGlobalFunction( "ADD_GRADED_RANDOM_OBJECT" );

DeclareGlobalFunction( "ADD_GRADED_RANDOM_MORPHISM_WITH_FIXED_SOURCE_LEFT" );

DeclareGlobalFunction( "ADD_GRADED_RANDOM_MORPHISM_WITH_FIXED_RANGE_LEFT" );

DeclareGlobalFunction( "ADD_GRADED_RANDOM_MORPHISM_WITH_FIXED_SOURCE_RIGHT" );

DeclareGlobalFunction( "ADD_GRADED_RANDOM_MORPHISM_WITH_FIXED_RANGE_RIGHT" );

DeclareGlobalFunction( "TRY_TO_ENHANCE_HOMALG_GRADED_RING_WITH_RANDOM_FUNCTIONS" );
