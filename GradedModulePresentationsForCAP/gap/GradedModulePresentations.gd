...
DeclareGlobalFunction( "ENHANCE_GRADED_RING_WITH_RANDOM_FUNCTIONS" );

DeclareGlobalFunction( "ADD_GRADED_RANDOM_OBJECT_LEFT" );
...
DeclareGlobalFunction( "ADD_GRADED_RANDOM_OBJECT_RIGHT" );
