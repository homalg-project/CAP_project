...
#! Q[x_1,x_2,x_3,x_4] (with weights [ [ 1, 0 ], [ 1, 0 ], [ 0, 1 ], [ 0, 1 ] ]) )>
Display( c );
#! A morphism of a Freyd category
#!
#! Morphism datum:
#! A morphism in the category of graded rows over Q[x_1,x_2,x_3,x_4] 
#! (with weights [ [ 1, 0 ], [ 1, 0 ], [ 0, 1 ], [ 0, 1 ] ]) with matrix: 
...
#!
#! Morphism datum:
#! A morphism in the category of graded columns over Q[x_1,x_2,x_3,x_4] (wit\
#! h weights [ [ 1, 0 ], [ 1, 0 ], [ 0, 1 ], [ 0, 1 ] ]) with matrix:
#! 2
#! (over a graded ring)
Display( CokernelProjection( z ) );
#! A morphism of a Freyd category
