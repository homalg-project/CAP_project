...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return List( [ 1 .. deduped_4_1 ], function ( logic_new_func_x_2 )
            ...
            morphism_attr_1_2 := ConvertRowToMatrix( CertainRows( hoisted_1_1, [ logic_new_func_x_2 ] ), hoisted_2_1, hoisted_3_1 );
            return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                   ), cat_1, ObjectifyObjectForCAPWithAttributes( rec(
                     ), cat_1, RankOfObject, NrColumns( morphism_attr_1_2 ) ), ObjectifyObjectForCAPWithAttributes( rec(
                     ), cat_1, RankOfObject, NrRows( morphism_attr_1_2 ) ), UnderlyingMatrix, morphism_attr_1_2 );
        end );
end
########
