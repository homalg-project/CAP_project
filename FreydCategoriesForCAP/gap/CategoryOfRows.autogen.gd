...
#! * <Ref BookName="MonoidalCategories" Func="InternalCoHomToTensorProductLeftAdjunctionMap" Label="for Is" />
#! * <Ref BookName="MonoidalCategories" Func="InternalCoHomToTensorProductLeftAdjunctionMapWithGivenTensorProduct" Label="for Is" />
#! * <Ref BookName="MonoidalCategories" Func="InternalCoHomToTensorProductRightAdjunctionMap" Label="for Is" />
#! * <Ref BookName="MonoidalCategories" Func="InternalCoHomToTensorProductRightAdjunctionMapWithGivenTensorProduct" Label="for Is" />
...
#! * <Ref BookName="MonoidalCategories" Func="TensorProductToInternalCoHomLeftAdjunctionMap" Label="for Is" />
#! * <Ref BookName="MonoidalCategories" Func="TensorProductToInternalCoHomLeftAdjunctionMapWithGivenInternalCoHom" Label="for Is" />
#! * <Ref BookName="MonoidalCategories" Func="TensorProductToInternalCoHomRightAdjunctionMap" Label="for Is" />
#! * <Ref BookName="MonoidalCategories" Func="TensorProductToInternalCoHomRightAdjunctionMapWithGivenInternalCoHom" Label="for Is" />
