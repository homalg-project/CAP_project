...
InstallGlobalFunction( INSTALL_FUNCTIONS_FOR_CAP_CATEGORY_OF_GRADED_ROWS,
  ...
  function( category, checks )
    ...
    AddIsEqualForObjects( category,
      ...
      local deg_list1, deg_list2, comparer_list, i, j, counter1, counter2, len, pos1, pos2;
    ...
    AddProjectionInFactorOfFiberProductWithGivenFiberProduct( category,
      function( morphism_list, projection_number, fibre_product_object )
        ...
        if Length( morphism_list ) = 0 then
          ...
          return GradedRowOrColumnMorphism( fibre_product_object,
                                                                          projection_matrix,
    ...
    AddTensorUnit( category,
      function( )
        ...
        return GradedRow( [ [ TheZeroElement( DegreeGroup( homalg_ring ) ) , 1 ] ],
                                                               homalg_ring,
                                                               checks
                                                              );
