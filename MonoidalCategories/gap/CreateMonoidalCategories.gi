...
InstallGlobalFunction( CAP_INTERNAL_FUNC_FOR_MONOIDAL_STRUCTURES,
  function( key_val_rec, package_name )
    ...
    L := [ "IsMonoidalCategory",
           ...
           "DirectSum",
           "Braiding",
           ["LeftClosedMonoidalLambda", "LeftCoclosedMonoidalLambda"],
           ["LeftClosedMonoidalEvaluation", "LeftCoclosedMonoidalEvaluation"],
           ["LeftClosedMonoidalCoevaluation", "LeftCoclosedMonoidalCoevaluation"],
           "MONOIDAL",
           "Monoidal",
           "monoidal",
           "DISTRIBUTIVE",
