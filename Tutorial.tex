...
\texttt{WithGiven} operations \todo{reference} offer an advantage. Instead of calling a function with only $\alpha$ and $\beta$, there
...
Please have a look at \todo{reference} for more details about the \texttt{WithGiven} functions.
...
\]
For more information about this system, please refer to the chapter about derivations \todo{reference}.
