...
\begin{center}   
 \begin{tikzpicture}[mystyle/.style={scale=.7}]
  ...
  {
    &|[name=A]| \mathbb{Z}^1 &|[name=B]| \mathbb{Z}^3 &|[name=C]| \mathbb{Z}^2 &|[name=01]| 0 \phantom{\mathbb{Z}^2}  \\
    |[name=02]| \phantom{\mathbb{Z}^2} 0 &|[name=A']| \mathbb{Z}^2 &|[name=B']| \mathbb{Z}^3 &|[name=C']| \mathbb{Z}^1 \\
  }; 
...
After those examples of computational power we end this tutorial for the Abelian category in \CapPkg.
