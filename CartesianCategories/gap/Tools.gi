...
##
WriteFileForLeftClosedMonoidalStructureAdjunction(
        rec(
             IsMonoidalCategory := "IsCartesianCategory",
             IsStrictMonoidalCategory := "IsStrictCartesianCategory",
             IsBraidedMonoidalCategory := "IsCartesianCategory",
             ...
             safe_replace := [ ######################################
                               ...
                               [ "dual_operation := \"UniversalPropertyOfLeftCoDual\"",
                                 "dual_operation := \"UniversalPropertyOfCocartesianDual\"" ],
                               [ "LEFT_CLOSED_MONOIDAL_CATEGORIES_ADJUNCTION",
                                 "CARTESIAN_CLOSED_CATEGORIES_LEFT_ADJUNCTION" ],
                               ##############################
                               ## Safe replacements for Tests
                               ##############################
                               ## Evalutions
        ...
        "CartesianCategories",
        rec( LeftClosedMonoidalCategoriesAdjunction_gd := "CartesianClosedCategoriesLeftAdjunction.gd",
             LeftClosedMonoidalCategoriesAdjunctionMethodRecord_gi := "CartesianClosedCategoriesLeftAdjunctionMethodRecord.gi",
             LeftClosedMonoidalCategoriesAdjunctionDerivedMethods_gi := "CartesianClosedCategoriesLeftAdjunctionDerivedMethods.gi",
             )
        );
...
##
WriteFileForLeftCoclosedMonoidalStructureAdjunction(
        rec(
             IsMonoidalCategory := "IsCocartesianCategory",
             IsStrictMonoidalCategory := "IsStrictCocartesianCategory",
             IsBraidedMonoidalCategory := "IsCocartesianCategory",
             ...
             safe_replace := [ ######################################
                               ...
                               [ "dual_operation := \"UniversalPropertyOfLeftDual\"",
                                 "dual_operation := \"UniversalPropertyOfCartesianDual\"" ],
                               [ "LEFT_CLOSED_AND_LEFT_COCLOSED_MONOIDAL_CATEGORIES_ADJUNCTION",
                                 "CARTESIAN_CLOSED_AND_COCARTESIAN_COCLOSED_CATEGORIES_LEFT_ADJUNCTION" ],
                               [ "LEFT_COCLOSED_MONOIDAL_CATEGORIES_ADJUNCTION_METHOD",
                                 "COCARTESIAN_COCLOSED_CATEGORIES_LEFT_ADJUNCTION_METHOD" ],
                               [ "LEFT_CLOSED_MONOIDAL_CATEGORIES_ADJUNCTION",
                                 "CARTESIAN_CLOSED_CATEGORIES_LEFT_ADJUNCTION" ],
                               [ "LeftCoclosedMonoidalCategoriesAdjunction.autogen.gd",
                                 "CocartesianCoclosedCategoriesLeftAdjunction.autogen.gd" ],
        ...
        "CartesianCategories",
        rec( LeftCoclosedMonoidalCategoriesAdjunction_gd := "CocartesianCoclosedCategoriesLeftAdjunction.gd",
             LeftCoclosedMonoidalCategoriesAdjunctionMethodRecord_gi := "CocartesianCoclosedCategoriesLeftAdjunctionMethodRecord.gi",
             LeftCoclosedMonoidalCategoriesAdjunctionDerivedMethods_gi := "CocartesianCoclosedCategoriesLeftAdjunctionDerivedMethods.gi",
             )
        );
