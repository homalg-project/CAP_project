...
CoproductOfMorphismAndIdentity := rec(
  filter_list := [ "category", "morphism", "morphism" ],
  return_type := "morphism",
  input_arguments_names := [ "cat", "alpha", "id_b" ],
  output_source_getter_string := "BinaryCoproduct( cat, Source( alpha ), Source( id_b ) )",
  output_source_getter_preconditions := [ [ "Coproduct", 1 ] ],
  output_range_getter_string := "BinaryCoproduct( cat, Range( alpha ), Range( id_b ) )",
  output_range_getter_preconditions := [ [ "Coproduct", 1 ] ],
  with_given_object_position := "both",
  dual_operation := "DirectProductOfMorphismAndIdentity",
  dual_arguments_reversed := false,
  compatible_with_congruence_of_morphisms := true,
  # Test in MonoidalCategoriesTest
),

CoproductOfMorphismAndIdentityWithGivenCoproducts := rec(
  filter_list := [ "category", "object", "morphism", "morphism", "object" ],
  return_type := "morphism",
  ...
  output_range_getter_string := "r",
  output_range_getter_preconditions := [ ],
  dual_operation := "DirectProductOfMorphismAndIdentityWithGivenDirectProducts",
  dual_with_given_objects_reversed := true,
  compatible_with_congruence_of_morphisms := true,
),

CoproductOfIdentityAndMorphism := rec(
  filter_list := [ "category", "morphism", "morphism" ],
  return_type := "morphism",
  input_arguments_names := [ "cat", "id_a", "beta" ],
  output_source_getter_string := "BinaryCoproduct( cat, Source( id_a ), Source( beta ) )",
  output_source_getter_preconditions := [ [ "Coproduct", 1 ] ],
  output_range_getter_string := "BinaryCoproduct( cat, Range( id_a ), Range( beta ) )",
  output_range_getter_preconditions := [ [ "Coproduct", 1 ] ],
  with_given_object_position := "both",
  dual_operation := "DirectProductOfIdentityAndMorphism",
  dual_arguments_reversed := false,
  compatible_with_congruence_of_morphisms := true,
  # Test in MonoidalCategoriesTest
),

CoproductOfIdentityAndMorphismWithGivenCoproducts := rec(
  filter_list := [ "category", "object", "morphism", "morphism", "object" ],
  return_type := "morphism",
  ...
  output_range_getter_string := "r",
  output_range_getter_preconditions := [ ],
  dual_operation := "DirectProductOfIdentityAndMorphismWithGivenDirectProducts",
  dual_with_given_objects_reversed := true,
  compatible_with_congruence_of_morphisms := true,
),
