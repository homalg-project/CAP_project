...
InstallGlobalFunction( "CocartesianCategoriesTest",
    function( cat, opposite, a, b, c, alpha, beta )
        ...
        if CanCompute( cat, "CoproductOfMorphismAndIdentity" ) then
            
            alpha_tensor_id_b := CoproductOfMorphismAndIdentity( alpha, id_b );
            beta_tensor_id_a := CoproductOfMorphismAndIdentity( beta, id_a );
            
            alpha_tensor_id_b_op := DirectProductOfMorphismAndIdentity( opposite, alpha_op, id_b_op );
            beta_tensor_id_a_op := DirectProductOfMorphismAndIdentity( opposite, beta_op, id_a_op );
        ...
        if CanCompute( cat, "CoproductOfIdentityAndMorphism" ) then
            
            id_b_tensor_alpha := CoproductOfIdentityAndMorphism( id_b, alpha );
            id_a_tensor_beta := CoproductOfIdentityAndMorphism( id_a, beta );
            
            id_b_tensor_alpha_op := DirectProductOfIdentityAndMorphism( opposite, id_b_op, alpha_op );
            id_a_tensor_beta_op := DirectProductOfIdentityAndMorphism( opposite, id_a_op, beta_op );
