...
structure_record.DirectSum :=
  function( obj_list, underlying_direct_sum )
      ...
      return [ DirectSumFunctorial( List( obj_list, obj -> ObjectAttributesAsList( obj )[1] ) ) ];
...
structure_record.Lift :=
  function( mono, range )
      ...
      return [ LiftAlongMonomorphism( mono, PreCompose( mono, ObjectAttributesAsList( range )[1] ) ) ];
...
structure_record.Colift :=
  function( epi, source )
      ...
      return [ ColiftAlongEpimorphism( epi, PreCompose( ObjectAttributesAsList( source )[1], epi ) ) ];
...
structure_record.TensorUnit :=
  function( underlying_tensor_unit )
      ...
      return [ IdentityMorphism( underlying_tensor_unit ) ];
...
structure_record.TensorProductOnObjects :=
  function( object1, object2, underlying_tensor_product )
      ...
      return [ TensorProductOnMorphisms( ObjectAttributesAsList( object1 )[1], ObjectAttributesAsList( object2 )[1] ) ];
...
structure_record.DualOnObjects :=
  function( object, dual_object )
      ...
      return [ DualOnMorphisms( ObjectAttributesAsList( object )[1] ) ];
...
structure_record.InternalHomOnObjects :=
  function( object1, object2, underlying_internal_hom )
      ...
      return [ TensorProductOnMorphisms( DualOnMorphisms( ObjectAttributesAsList( object1 )[1] ), 
               ObjectAttributesAsList( object2 )[1] ) ];
...
AddIsEqualForObjects( category_of_objects_with_endomorphism,
  function( object1, object2 )
    ...
    return IsEqualForObjects( UnderlyingCell( object1 ), UnderlyingCell( object2 ) )
           and IsCongruentForMorphisms( ObjectAttributesAsList( object1 )[1], ObjectAttributesAsList( object2 )[1] );
...
AddIsEqualForMorphisms( category_of_objects_with_endomorphism,
  function( morphism1, morphism2 )
    ...
    return IsCongruentForMorphisms( UnderlyingCell( morphism1 ), UnderlyingCell( morphism2 ) );
